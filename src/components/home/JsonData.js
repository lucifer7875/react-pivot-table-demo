export const Data = [
    ['Salesperson', 'Region', 'Product', 'Date', 'Sales Amount'],
    ['Alice', 'North', 'Product A', '2023-01-01', 1200],
    ['Bob', 'South', 'Product B', '2023-01-02', 800],
    ['Alice', 'East', 'Product A', '2023-01-03', 950],
    ['Charlie', 'West', 'Product C', '2023-01-04', 1300],
    ['Bob', 'North', 'Product B', '2023-01-05', 700],
    ['Alice', 'South', 'Product A', '2023-01-06', 1100],
    ['Charlie', 'East', 'Product C', '2023-01-07', 1150],
    ['Bob', 'West', 'Product B', '2023-01-08', 900],
    ['Alice', 'North', 'Product A', '2023-01-09', 1250],
    ['Charlie', 'South', 'Product C', '2023-01-10', 1050],
];
